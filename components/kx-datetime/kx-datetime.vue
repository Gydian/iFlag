...
<script>
	...
	export default {
		...
		methods: {
			...
			ok() {
				let day=this.day<10?'0'+this.day:this.day,month=this.month<10?'0'+this.month:this.month,hour=this.hour<10?'0'+this.hour:this.hour,min=this.min<10?'0'+this.min:this.min
